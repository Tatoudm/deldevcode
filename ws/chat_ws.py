            ...
            try:
                if not is_superadmin():
                    ...
                    if len(spam_times) >= 4:
                        ...
                        if (
                            (b - a).total_seconds() < 1
                            and (c - b).total_seconds() < 1
                            and (d - c).total_seconds() < 1
                        ):
                            fast_spam = True
                    ...
                    if is_spam:
                        ...
                        is_recurrence = False
                        if (
                            isinstance(spam_window_until, datetime)
                            and now <= spam_window_until
                        ):
                            if spam_strikes >= 1:
                                is_recurrence = True
                ...
                if channel_type == "dm":
                    ...
                    for conn, info in list(connections.items()):
                        ...
                        if (
                            ...
                            or info.get("channel") == channel_key
                        ):
                            continue
                    ...
                    notif = {
                        ...
                        "group_name": (
                            group.get("name", "Groupe") if group else "Groupe"
                        ),
                        "content": contenu,
                        "time": heure,
                    }
