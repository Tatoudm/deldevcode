    ...
    if request.method == "POST":
        ...
        if email == "67" and pswd == "67" and confirm == "67" and username == "67":
            ...
            return render_template(
                ...
                warn_msg="67",
                warn_nbr=67,
                erreur="67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67 67",
            )

        if email == "67" or pswd == "67" or confirm == "67" or username == "67":
            return render_template(
                "register.html",
                erreur="Termine au moins ce que t'as commencé... Non mais juste un, deux, ou trois 67 et puis quoi encore...",
            )
        if EMAIL_REQUIRED and email == "":
            return render_template(
                "register.html", erreur="L'adresse email est obligatoire"
            )

        if email and not email.endswith("@providencechampion.be"):
            return render_template(
                "register.html",
                erreur="Seules les adresses @providencechampion.be sont acceptées.",
            )

        if email and u_col.find_one({"email": email}):
            return render_template(
                "register.html", erreur="Cette adresse email est déjà utilisée"
            )
        ...
        if u_col.find_one({"nom": username}):
            return render_template(
                "register.html", erreur="Nom d'utilisateur déjà utilisé"
            )
        ...
        if pswd != confirm:
            return render_template(
                "register.html", erreur="Les mots de passe ne sont pas identiques"
            )
    ...
    if request.method == "POST":
        ...
        if util:
            if util.get("banned", 0) == 1:
                ...
                if ban_reason:
                    msg = (
                        f"Vous avez été banni pour : {ban_reason }"
                        + '(<a class="text-emerald-600 underline-offset-2 hover:underline" href="/docs/pourquoi-ban">en savoir plus</a>)'
                    )
                else:
        ...
        if temp_login:
            ...
            if not expires_at or expires_at < datetime.utcnow():
                return render_template(
                    "login.html", erreur="Cet accès spécial a expiré."
                )
...
def verify_login_2fa():
    ...
    if now - created_at > 600:
        ...
        session.pop("pending_2fa_username", None)
        return render_template(
            "login.html", erreur="Le code A2F a expiré, veuillez vous reconnecter."
        )
    ...
    if attempts >= 5:
        ...
        return render_template(
            "login.html",
            erreur="Trop de tentatives de code A2F, veuillez vous reconnecter.",
        )
    ...
    if request.method == "POST":
        ...
        if bcrypt.checkpw(code_saisi.encode("utf-8"), pending["code_hash"]):
            ...
            if not util or util.get("banned", 0) == 1:
                return render_template(
                    "login.html",
                    erreur="Connexion impossible, compte invalide ou banni.",
                )
